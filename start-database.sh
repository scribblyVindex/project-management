...
DB_CONTAINER_NAME="easy-slr-postgres"
...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=$DB_PASSWORD -e POSTGRES_DB=easy-slr -d -p 5432:5432 docker.io/postgres
